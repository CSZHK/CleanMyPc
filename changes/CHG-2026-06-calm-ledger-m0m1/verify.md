...
| 6 | 宋体 cascade | swift test --package-path Packages --filter AtlasDesignSystemTests.testLedgerFontCascadeResolvesSongtiForChinese | PASS（FAIL 即触发规格 §1.3 降级决策点，升级人审） |

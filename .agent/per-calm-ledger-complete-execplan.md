...
## M3 CLOSEOUT (2026-06-11)
- 8 屏 + 壳层全部 Calm Ledger 化；路由 history→ledger；裁决 A/B 落地；恢复红线守。
- 门禁: Packages 578/0 · Apps 58/0 · contrast 36/36 · build 0 新 warning · rebase main no-op。
